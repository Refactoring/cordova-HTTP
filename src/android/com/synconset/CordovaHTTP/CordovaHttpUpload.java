...
public class CordovaHttpUpload extends CordovaHttp implements Runnable {
    ...
    public CordovaHttpUpload(String urlString, JSONObject params, Map<String, String> headers, CallbackContext callbackContext, String filePath, String name) throws JSONException {
